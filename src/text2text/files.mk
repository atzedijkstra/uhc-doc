...
$(TEXT2TEXT_BLD_EXEC): $(TEXT2TEXT_AG_ALL_MAIN_DRV_HS) $(TEXT2TEXT_HS_ALL_DRV_HS)
	$(GHC) --make -XFlexibleContexts -XScopedTypeVariables -XTypeSynonymInstances -XFlexibleInstances -XImpredicativeTypes $(GHC_OPTS) $(GHC_OPTS_OPTIM) $(GHC_OPTS_WHEN_EHC) -i$(TEXT2TEXT_BLD_PREFIX) $(TEXT2TEXT_BLD_PREFIX)$(TEXT2TEXT_MAIN).hs -o $@
	$(STRIP) $@
