...
HMDEMO_LAM_VARIANT_A_VIA_AG_STEPWISE		:= 3
HMDEMO_LAM_VARIANT_ORDER					:= $(HMDEMO_LAM_VARIANT_A_VIA_HS) < $(HMDEMO_LAM_VARIANT_A_VIA_AG) < $(HMDEMO_LAM_VARIANT_A_VIA_AG_STEPWISE)
HMDEMO_LAM_VARIANTS							:= $(HMDEMO_LAM_VARIANT_A_VIA_HS) $(HMDEMO_LAM_VARIANT_A_VIA_AG) $(HMDEMO_LAM_VARIANT_A_VIA_AG_STEPWISE)
...
HMDEMO_VARIANT_A_AGSTEPW_SUFF				:= $(HMDEMO_VARIANT_A_SUFF)_$(HMDEMO_LAM_VARIANT_A_VIA_AG_STEPWISE)
...
HMDEMO_LAM_RUL_DRV_A_AGSTEPW_AG				:= $(patsubst $(SRC_HMDEMO_PREFIX)%.cag,$(TEXT_TMP_VARIANT_PREFIX)%_$(HMDEMO_LAM_VARIANT_A_VIA_AG_STEPWISE).ag,$(HMDEMO_LAM_SRC_CAG_A))
HMDEMO_LAM_RUL_DRV_A_AGSTEPW_HS				:= $(patsubst %.ag,%.hs,$(HMDEMO_LAM_RUL_DRV_A_AGSTEPW_AG))
...
HMDEMO_A_AGSTEPW_MAIN						:= Lam$(HMDEMO_VARIANT_A_AGSTEPW_SUFF)_Main
HMDEMO_A_AGSTEPW_MAIN_BLD_EXEC				:= $(TEXT_TMP_VARIANT_PREFIX)$(HMDEMO_A_AGSTEPW_MAIN)$(EXEC_SUFFIX)
#HMDEMO_A_AGSTEPW_MAIN						:= $(HMDEMO_A_AGSTEPW_MAIN_BLD_EXEC)

HMDEMO_ALL_BLD_EXEC							:= $(HMDEMO_A_HS_MAIN_BLD_EXEC) $(HMDEMO_A_AG_MAIN_BLD_EXEC) $(HMDEMO_A_AGSTEPW_MAIN_BLD_EXEC)
...
$(HMDEMO_LAM_RUL_DRV_A_AGSTEPW_AG) : $(HMDEMO_LAM_SRC_CAG_A) $(HMDEMO_LAM_MKF)
	mkdir -p $(@D)
...
$(HMDEMO_LAM_RUL_DRV_A_AGSTEPW_HS) : $(HMDEMO_LAM_RUL_DRV_A_AGSTEPW_AG) $(HMDEMO_LAM_RUL_DRV_A_AGR) $(HMDEMO_LAM_MKF)
	mkdir -p $(@D)
...
$(HMDEMO_A_AGSTEPW_MAIN_BLD_EXEC) : $(HMDEMO_LAM_RUL_DRV_A_AGSTEPW_HS)
	mkdir -p $(@D)
