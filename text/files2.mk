...
TEXT_SUBS_DRV_TEX			:= $(if $(TEXT_CFG_TEXT_INCLUDES_PREV_RULER_TEX),$(RULER_12_DRV_TEX)) \
								$(if $(TEXT_CFG_TEXT_INCLUDES_RULER_EHC_TEX),$(RULER2_RULES_DRV_TEX) $(RULER_3_DRV_TEX) $(RULER_4_DRV_TEX)) \
								$(if $(TEXT_CFG_TEXT_INCLUDES_RULER_EHC_TEX),$(TEXT_RULES_3_DRV_TEX)) \
								$(if $(TEXT_CFG_TEXT_INCLUDES_RULER_MISC_TEX),$(TEXT_RULES_MISC_DRV_TEX))
...
TEXT_SUBS_SHUFFLE1			:= $(TEXT_SUBS_SRC_CLTEX) \
								$(if $(TEXT_CFG_TEXT_INCLUDES_RULER_EHC_TEX),$(TEXT_RULES_3_DRV_CAG)) \
								$(if $(TEXT_CFG_TEXT_INCLUDES_RULER_EHC_TEX),$(RULER2_ALL_CHUNK_SRC)) \
								$(if $(TEXT_CFG_TEXT_INCLUDES_RULER_TEX),$(AGPRIMER_ALL_CHUNK_SRC)) \
...
TEXT_SUBS_SHUFFLE_SRCS_HMDEMO \
							:= $(if $(TEXT_CFG_SHUFFLE_INCLUDES_CHUNK_SRC_HMDEMO),$(HMDEMO_ALL_SRC_CAG) $(HMDEMO_ALL_SRC_CRUL))
...
$(TEXT_INCL_LIST_TEX): $(TEXT_ALL_MK_FILES)
	@(for f in $(sort $(notdir $(TEXT_SUBS_DRV_TEX) \
	                           ...
	                           $(if $(TEXT_CFG_TEXT_INCLUDES_RULER_INF2PS_TEX),$(TEXT_INF2PS_ALL_DRV_TEX) ) \
	                           $(if $(TEXT_CFG_TEXT_INCLUDES_RULER_EHC_TEX),$(RULER_4_DRV_TEX) $(RULER_3_DRV_TEX)) \
	                           $(if $(TEXT_CFG_TEXT_INCLUDES_RULER_UX_TEX),$(TEXT_RULEUX_ALL_DRV_TEX) $(TEXT_RULEX_ALL_DRV_TEX)) \
	            )      ) ; \
	  do \
	    echo "\\input" $$f ; \
	  done \
